...
# --------------------------------------------------------------------- #
# resolve_device -- full coverage lives in tests/test_utils.py, this just
# confirms train.py still re-exports action_recognition.utils.device's
# implementation for backward compatibility (e.g. `--device` CLI flag).
# --------------------------------------------------------------------- #
