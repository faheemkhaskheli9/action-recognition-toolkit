...
# manage.py, the `core` app, and this `webapp` settings package all live
# directly under the repo root, so BASE_DIR (parent of this file's directory,
# i.e. webapp/) *is* the repo root.
BASE_DIR = Path(__file__).resolve().parent.parent

# Alias for readability at call sites — the web app reads/writes the same
# data/, configs/, runs/ the CLI tools use, all resolved from the repo root.
REPO_ROOT = BASE_DIR
