...
urlpatterns = [
    ...
    path("dataset/", dataset.dataset_list, name="dataset_list"),
    path("datasets/", datasets.manage_datasets, name="manage_datasets"),
    path("datasets/<int:pk>/delete/", datasets.delete_dataset, name="delete_dataset"),
    ...
    path("label/add-span/", labeling.add_span, name="add_span"),
    path("label/delete-span/", labeling.delete_span, name="delete_span"),
    path("label/finish/", labeling.finish_video, name="finish_video"),
    path("label/skip/", labeling.skip_video, name="skip_video"),
    path("label/skip-group/", labeling.skip_group, name="skip_group"),
    path("label/track/", labeling.label_track, name="label_track"),
